...
public class BrowserList {
    ...
    public Browser switchToNextBrowser() throws BrowserListIsEmptyException {
    ...
    public Browser switchToBrowserByIndex(int index) throws BrowserListIsEmptyException, NoBrowserException {

        if (this.isEmpty()) {
            throw new BrowserListIsEmptyException();
        }
